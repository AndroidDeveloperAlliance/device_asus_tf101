cmd_scripts/kconfig/kxgettext.o := gcc -Wp,-MD,scripts/kconfig/.kxgettext.o.d -Iscripts/kconfig -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -DCURSES_LOC="<ncurses.h>" -DLOCALE -DKBUILD_NO_NLS -c -o scripts/kconfig/kxgettext.o /Volumes/Jenkins/cm/kernel/asus/tf101/scripts/kconfig/kxgettext.c

source_scripts/kconfig/kxgettext.o := /Volumes/Jenkins/cm/kernel/asus/tf101/scripts/kconfig/kxgettext.c
